...
class SEGPOAController extends Controller
{
    ...
    function get_seguimiento(Request $request){
          //aca se ejecuta el query: select * from actividad_segs where actividad_id = $request 
        $seg = Actividad_segs::where('actividad_id', $request['actividad'])
            ->get();

        $seguimiento = $seg[0]->user_id;
    ...
    {
        // aqui hay que adicionar las tareas
        ...
        return view(('SEGPOA.index'),compact('privilegios','actividades','objetivos'));
    }
    ...
    public function create()
    {
        ...
        $actividads = actividads::all();
        //$seg=$this->get_seguimiento(1);
        //echo $seg->m1;
        return view(('SEGPOA.create'),compact('privilegios','objetivos','objetivo_esps','areas','indicadores','unidades','actividads'));
    }
    ...
    public function show($id)
    {
        ...
        $unidades = unidads::all();
        $objetivo_esps = objetivo_esps::all();
        return view(('SEGPOA.modificar'),compact('privilegios','actividad','objetivos','objetivo_esps','areas','indicadores','unidades'));
    }
